...
legend.onAdd = function () { 
    ...
    div.innerHTML = 
        ...
        '<div><svg style="display:block;margin:auto;text-align:center;stroke-width:1;stroke:rgb(0,0,0);"><circle cx="15" cy="8" r="5" fill="#f8daee" /></svg></div>Jembatan<br>' + 
        ...
        '<div style="background-color:rgb(190, 241, 190); height: 10px;"></div>Permukiman dan Tempat Kegiatan<br>' + 
